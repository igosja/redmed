...
class NewscategoryController extends AController
{
    public $h1 = 'Категории статей';
    public $h1_edit = 'Редактирование категории статей';
    public $title_index = 'Категории статей';
    public $title_create = 'Создание';
    public $title_update = 'Редактирование';
    public $model_name = 'NewsCategory';
