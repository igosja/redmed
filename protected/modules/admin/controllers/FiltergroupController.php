...
class FiltergroupController extends AController
{
    public $h1 = 'Группы фильтров';
    public $name_edit = 'Редактирование группы фильтров';
    public $title_index = 'Группы фильтров';
    public $title_create = 'Создание';
    public $title_update = 'Редактирование';
    public $model_name = 'FilterGroup';
